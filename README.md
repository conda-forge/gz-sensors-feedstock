...
pixi add gz-sensors libgz-sensors
# for installing globally
pixi global install gz-sensors libgz-sensors
```
...
It is possible to list all of the versions of `gz-sensors` available on your platform:
...
```
pixi search gz-sensors --channel conda-forge
```
