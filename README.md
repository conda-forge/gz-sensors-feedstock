...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/gz-sensors-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/gz-sensors-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
Once the `conda-forge` channel has been enabled, `gz-sensors, gz-sensors9, libgz-sensors, libgz-sensors9` can be installed with `conda`:

```
conda install gz-sensors gz-sensors9 libgz-sensors libgz-sensors9
```

or with `mamba`:

```
mamba install gz-sensors gz-sensors9 libgz-sensors libgz-sensors9
```
